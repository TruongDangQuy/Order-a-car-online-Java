...
public class EditProduct extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String MaTP = request.getParameter("pid");
            UserProduct up = new UserProduct();
            up = DBUtils.getProductByMaTP(conn, MaTP);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            UserProduct up = DBUtils.getProductByMaTP(conn,MaTP);
            //HttpSession sess=request.getSession();
            //UserAccount ua = (UserAccount) sess.getAttribute("acc");
            ...
            DBUtils.updateProduct(conn,MaTP, TenTP, GiaTP, SLCon, HinhAnh, DVT, MaLoai);
