...
public class TypeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String MaLoai=request.getParameter("tid");
        List<UserProduct> list=new ArrayList<UserProduct>();
        List<UserType> listT=new ArrayList<UserType>();
        List<UserProduct> listL=new ArrayList<UserProduct>();
        ...
        try
        {
            ...
            list=DBUtils.getUserProductByMaLoai(conn,MaLoai);
            listT=DBUtils.selectType(conn);
            listL=DBUtils.LastProduct(conn);
        ...
        catch(SQLException e)
        {
            ...
            request.setAttribute("listLast",listL);
